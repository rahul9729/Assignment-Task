...
<div class="pull-left result"><h1>	Search Properties</h1> </div>
...
$query="select * from add_property where category='$category' and type='$typename'";
